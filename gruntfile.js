module.exports = function(grunt) {
    ...
    var siteConfig = {
        ...
        siteURL: "http://brady.dev"       // used for YSlow, validation, uncss
    };
    ...
    grunt.initConfig({
        ...
        gitadd: {
            resolveBuild: {
                files: {
                    src: [ '<%= config.outputFolder %>css/styles.css',
                           '<%= config.outputFolder %>css/styles.min.css',
                           '<%= config.outputFolder %>js/all.js',
                           '<%= config.outputFolder %>js/all.min.js',
    ...
    grunt.registerTask('resolve', [ 'default', 'harp:compile', 'gitadd:resolveBuild' ]);
